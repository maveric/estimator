            ...
            <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                ...
                <form wire:submit="save">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <!-- Labor Minutes -->
                        <div class="col-span-6 sm:col-span-4">
                            <x-label for="labor_minutes" value="{{ __('Labor Minutes') }}" />
                            <x-input id="labor_minutes" type="number" step="0.01" class="mt-1 block w-full" wire:model="labor_minutes" />
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            <label class="flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-600">{{ __('Is Template') }}</span>
                            </label>
                        </div>
                    ...
                    <div class="mt-6 flex justify-end">
                        <x-secondary-button type="button" class="mr-3" onclick="window.location.href='{{ route('items.index') }}'">
                            {{ __('Cancel') }}
                        </x-secondary-button>
