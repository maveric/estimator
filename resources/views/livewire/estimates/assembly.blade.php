        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-12 gap-4 items-start">
                <div class="col-span-4 flex items-start space-x-2">
                    ...
                    <div>
                        <h3 class="text-lg font-medium text-gray-900">{{ $assembly->name }}</h3>
                ...
                <div class="col-span-2 flex justify-end items-center space-x-2">
                    <span class="text-sm text-gray-500">Qty: {{ $assembly->quantity }}</span>
            ...
            @unless($isCollapsed)
                ...
                <div>
                    ...
                    <div class="mb-4 bg-gray-50 p-4 rounded-lg">
                        <h4 class="text-sm font-medium text-gray-700 mb-2">Add Item</h4>
                        <div class="grid grid-cols-12 gap-4">
                            <div class="col-span-8">
                                <select wire:model="selectedItemId" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
                            ...
                            <div class="col-span-2">
                                <input type="number" wire:model="newItemQuantity" min="1" step="1" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" placeholder="Quantity">
                            </div>
                            <div class="col-span-2">
                                <button type="button" wire:click="addItem" class="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                    Add
                                </button>
                            </div>
                        </div>
